...
export default function NovoComercialPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (!res.ok) {
        throw new Error(json.error || "Erro ao criar comercial");
      }

      toast.success(
        <>
          <div>Comercial criado com sucesso!</div>
      ...
      router.push("/lideranca/equipe/comerciais");
    } catch (error: any) {
      toast.error(error.message || "Erro ao criar comercial");
    } finally {
      setLoading(false);
    }
  }
  ...
  return (
    <div className="font-sans space-y-4">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Novo Comercial</h1>
          <p className="text-sm text-gray-500">
            Adicione um novo comercial à sua equipe
          </p>
        </div>
        <Link
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            >
              ...
              <option value="SUPERVISOR_FRANQUIA">Supervisor Franquia</option>
              <option value="SUPERVISOR_ATENDIMENTO">Supervisor Atendimento</option>
