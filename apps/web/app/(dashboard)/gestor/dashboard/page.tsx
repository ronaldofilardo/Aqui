...
function AlertCard({
  ...
  return (
    <div className="bg-yellow-50 border-l-4 border-yellow-400 rounded-lg p-4 col-span-full">
      <div className="flex items-start justify-between">
        ...
        {action && (
          <button
            onClick={action}
            className="bg-yellow-600 text-white px-4 py-2 rounded-lg hover:bg-yellow-700 transition text-sm font-medium whitespace-nowrap ml-4"
          >
            {actionLabel}
          </button>
        )}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
          ...
          {topConsultores.length === 0 ? (
            <p className="text-gray-400 text-sm">Nenhum consultor registrado</p>
          ) : (
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
          ...
          {evolucao.length === 0 ? (
            <p className="text-gray-400 text-sm">Sem dados históricos</p>
          ) : (
            <div className="space-y-3">
              {evolucao.map((e, i) => {
